...
- Start Worker
  ...
  - Determine the Scala version used in your Spark environment and choose the appropriate Spark BigQuery connector
    ```
    from pyspark.sql import SparkSession

    spark = SparkSession.builder \
        .appName("CheckScalaVersion") \
        .getOrCreate()
  ...
  - Check spark-bigquery-connector relase

    https://github.com/GoogleCloudDataproc/spark-bigquery-connector/releases

    ![image](https://github.com/garjita63/de-zoomcamp-2024/assets/77673886/b0905465-437b-4c9b-95d9-8901512212d7)
    
  - Install the Spark BigQuery connector using the --packages option when starting PySpark session
    ```
    pyspark --packages com.google.cloud.spark:spark-bigquery-with-dependencies_2.12:0.36.1
    ```

    ![image](https://github.com/garjita63/de-zoomcamp-2024/assets/77673886/ab4381a3-dc47-4f9c-9cc0-9ec44e7f2357)

  - Create / download GCP Project Service Account and put in specific directory on server like in /root/.google/credentials

  - Create python script in server or Jupyter Ntebook, and run it

    **Read CSV files and Write to BigQuery : pyspark**
    ```
    import pyspark
    from pyspark.sql import SparkSession
    from pyspark.conf import SparkConf
    ...
    **Read CSV files and Write to BigQuery : pyspark & sparkSQL**
    ...
    - Review BigQuery Dataset Tables
      ...
      ![image](https://github.com/garjita63/de-zoomcamp-2024/assets/77673886/122d4931-c0b0-4b8b-a2b9-596b041b04de)

      ![image](https://github.com/garjita63/de-zoomcamp-2024/assets/77673886/1894e224-3f62-4308-9a23-971da961cdb1)

      ![image](https://github.com/garjita63/de-zoomcamp-2024/assets/77673886/53536b05-08f8-4e5a-9e51-c2669b9fe908)

      ![image](https://github.com/garjita63/de-zoomcamp-2024/assets/77673886/71a8b8e8-5a85-4b74-8d7a-bbba0f7b808e)

      ![image](https://github.com/garjita63/de-zoomcamp-2024/assets/77673886/307d8de5-3182-44df-9b9d-ca641e80365f)

      ![image](https://github.com/garjita63/de-zoomcamp-2024/assets/77673886/638e3bcb-38c9-4f6a-834c-99a8fe6a4483)
